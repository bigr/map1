...
JOIN symbols S2 ON ST_Distance(S1.way,S2.way) < 2500  AND S1.osm_id <> S2.osm_id AND 
  (S1.historic = S2.historic OR S1.amenity = S2.amenity OR S1.leisure = S2.leisure OR S1.man_made = S2.man_made OR (S1.tourism = S2.tourism AND S1.tourism != 'attraction') OR (S1.building = S2.building AND S1.building IN ('church','chapel')))
GROUP BY S1.osm_id;
