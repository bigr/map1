...
if ( !empty($RENDER_LAYER) ) {
	$RENDER_FERRY = $RENDER_LANDCOVER  = $RENDER_ACCESSAREA = $RENDER_COUNTRYFILL = $RENDER_BUILDING = $RENDER_BOUNDARY = $RENDER_WAY = $RENDER_ROUTE = $RENDER_CONTOUR = $RENDER_FISHNET = $RENDER_TEXT = $RENDER_COUNTRYTEXT = $RENDER_GRIDINFO = false;
...
/**
 * Enable/Disable ferry rendering
 */
$RENDER_FERRY = true;
